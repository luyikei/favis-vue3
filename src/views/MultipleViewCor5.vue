  ...
  <v-row no-gutters style="height: 100%;">
    <v-col md="5" class="d-flex flex-column" style="height: calc(100vh); ">
      ...
      <div style="flex: 1 0 auto; position: relative; width: 100%;">
        ...
        <ParallelCoordinates :ds="ds" :factorAxis="true" :isFactor="false" :commonProps="commonProps">
        </ParallelCoordinates>
      </div>
      <v-divider></v-divider>
      <div style="flex: 1 0 auto; position: relative; width: 100%;">
        <div class="viewtitle" style="position: absolute; top: 0; left: 0;">Parallel Coordinates: Factors</div>
        <ParallelCoordinates :ds="ds" :factorAxis="false" :isFactor="true" :commonProps="commonProps">
        </ParallelCoordinates>
      </div>
    </v-col>
    <v-divider vertical></v-divider>
